...
const INPUT_FILE_NAME: &str = "eva_single_kernel.bin";

#[test]
fn integration_test_single_kernel_eva() {
    common::integration_test(SIGNATURE_TYPE, INPUT_FILE_NAME);
}

#[test]
fn single_kernel_eva_reports_full_size_and_validates_crcs() {
    let file_path = common::sample_path(INPUT_FILE_NAME);
    ...
    assert!(signature.description.contains("single-kernel"));
    assert!(
